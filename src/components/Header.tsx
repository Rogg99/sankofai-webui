...
export default function Header() {
  ...
  useEffect(() => {
    ...
    document.body.setAttribute(
      ...
      daisyuiThemes[selectedTheme]?.['color-scheme'] ?? 'dark'
    );
  }, [selectedTheme]);
  ...
  return (
    <div className="flex flex-row items-center pt-6 pb-6 sticky top-0 z-10 bg-base-100">
      ...
      <div className="grow text-2xl font-bold ml-2">🩺 Sankof AI</div>
      ...
      <div className="flex items-center">
        {viewingChat && (
          <div className="dropdown dropdown-end">
            ...
            {/* settings button */}
        <div className="tooltip tooltip-bottom" data-tip="Paramètres">
        ...
        <div className="tooltip tooltip-bottom" data-tip="Thèmes">
